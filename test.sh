...
assert "main() { int a=5; return a; }" "5"
assert "main() { int a=5+2; return a; }" "7"
assert "main() { int a=5; int b=123; return a; }" "5"
assert "main() { int a=5; int b=123; return b; }" "123"
assert "main() { int a; int b; a=b=123; return a; }" "123"
assert "main() { int a; int b; a=b=123; return b; }" "123"
assert "main() { int var=12; int foo=23; return var; }" "12"
assert "main() { int var=12; int foo=23; return foo; }" "23"
assert "main() { int a=5; a=6; return a; }" "6"
